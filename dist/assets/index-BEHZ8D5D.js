...
`,a2=g.p`
  ...
  font-size: 0.95rem;
  line-height: 1.6;
`,l2=[{name:"Atulya Ojha",role:"Founder",bio:"Technical architect ensuring our infrastructure is robust, scalable, and cutting-edge."},{name:"Daniyal Ojha",role:"Founder",bio:"Visionary leader driving the strategic direction and innovation behind NexterCloud."},{name:"Darpan Ojha",role:"Founder",bio:"Reviewing operations and customer experience to deliver the best service possible."}],i2=()=>o.jsx(Jx,{children:o.jsxs(Kx,{children:[o.jsx(Fx,{children:"Meet Our Team"}),o.jsx(Wx,{children:"The visionary minds behind NexterCloud's success"}),o.jsx(Ix,{children:l2.map((i,u)=>o.jsxs(Px,{children:[o.jsx(e2,{children:i.name.charAt(0)}),o.jsx(t2,{children:i.name}),o.jsx(n2,{children:i.role}),o.jsx(a2,{children:i.bio})]},u))})]})}),Jc=Bt`
  from {
    opacity: 0;
...
`,G5=()=>{const[i,u]=w.useState(""),[c,s]=w.useState(""),[d,h]=w.useState(!1),[p,j]=w.useState(""),[v,y]=w.useState(""),T=Ut(),E=async O=>{O.preventDefault(),h(!0),j(""),y("");try{i==="admin@example.com"&&c==="admin123"?(y("Login successful!"),localStorage.setItem("adminToken","admin-secret-token"),setTimeout(()=>{T("/admin/dashboard")},1500)):j("Invalid credentials")}catch{j("Login failed. Please try again.")}finally{h(!1)}};return o.jsx(_5,{children:o.jsxs(U5,{children:[o.jsx(B5,{children:"Admin Login"}),o.jsxs("form",{onSubmit:E,children:[o.jsx(C0,{type:"email",placeholder:"Admin Email",value:i,onChange:O=>u(O.target.value),required:!0}),o.jsx(C0,{type:"password",placeholder:"Password",value:c,onChange:O=>s(O.target.value),required:!0}),p&&o.jsx(H5,{children:p}),v&&o.jsx(k5,{children:v}),o.jsx(L5,{type:"submit",disabled:d,children:d?"Logging in...":"Login"})]}),o.jsx(Y5,{to:"/",children:"← Back to Home"})]})})},q5=g.div`
  background: #0f172a;
  color: white;
  min-height: 100vh;
`,Q5=g.header`
...
`,mS=({onLogin:i})=>{const[u,c]=w.useState(""),[s,d]=w.useState(""),[h,p]=w.useState(!1),[j,v]=w.useState(""),[y,T]=w.useState(""),E=Ut(),O=async B=>{B.preventDefault(),p(!0),v(""),T("");try{const Y=await(await fetch(`${He()}/api/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:u,password:s})})).json();Y.success?(T("Login successful!"),localStorage.setItem("userToken",Y.token||"fake-user-jwt-token"),localStorage.setItem("userData",JSON.stringify(Y.user)),i(Y.user),setTimeout(()=>{E("/")},1500)):v(Y.error||"Login failed. Please try again.")}catch(k){console.error("Login error:",k),v("Login failed. Please try again.")}finally{p(!1)}};return o.jsx(iS,{children:o.jsxs(rS,{children:[o.jsx(oS,{children:"Login to Your Account"}),o.jsxs("form",{onSubmit:O,children:[o.jsx(N0,{type:"email",placeholder:"Email Address",value:u,onChange:B=>c(B.target.value),required:!0}),o.jsx(N0,{type:"password",placeholder:"Password",value:s,onChange:B=>d(B.target.value),required:!0}),j&&o.jsx(sS,{children:j}),y&&o.jsx(cS,{children:y}),o.jsx(uS,{type:"submit",disabled:h,children:h?"Logging in...":"Login"})]}),o.jsxs(fS,{children:["Don't have an account? ",o.jsx("button",{onClick:()=>E("/signup"),children:"Sign Up"})]}),o.jsx(dS,{to:"/",children:"← Back to Home"})]})})},hS=g.div`
  display: flex;
  justify-content: center;
  align-items: center;
  min-height: 100vh;
